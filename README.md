...
## Automatic DSA organization

Submissions committed under `Data Structures & Algorithms/` are also copied to:

```text
DSA Organized/<Difficulty>/<Category>/<problem-slug>/
```

The original submission remains in place so NeetCode's GitHub Sync history is
...
Preview locally without changing files:
